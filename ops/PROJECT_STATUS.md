...
- TASK-350: Active-seed selection for planting (currently always plants rice) (#196)
...
- TASK-341: 3 more romance candidates (Ek/Chang/Klong/Yaa cast, formerly Kiet/Malee/Kanya) (#193)
...
- TASK-327: Seed purchasing + market shop UI (blocker found while scoping TASK-326)
- TASK-326: Shipping-milestone stamina progression
- TASK-325: Working pets/mounts (redesigned: companion bond + race tie-in)
- TASK-324: Life-progression events beyond current marriage ceiling
- TASK-323: Livestock depth (quality tiers + breeding)
- TASK-322: Farm/house building upgrades (carpenter-equivalent sink)
...
- TASK-007: World render: 20x16 tilemap matrix + Y-sort layers + bounds + edge dressing
...
- #206: TASK-360: Extend rain-day schedule routing beyond Elder/Child
- #205: TASK-359: Fog weather effect (currently unused data)
- #204: TASK-358: Animal weather-care system (feed cost, outside/inside state, sickness)
- #202: TASK-356: Indoor ambience + explicit indoor/outdoor time-pause decision
- #173: App Store icon set missing

## Milestones

### Scene-transition track (current focus) — partially Backlog
Sprint order: #199 → #203 → #201 → #200 → #202.
- TASK-353 (#199): Fix scene-transition spawn drift — **Done**
- TASK-357 (#203): Multi-scene world topology framework — **Done**
- TASK-355 (#201): Give the farmhouse interior real function — **Done**
- TASK-354 (#200): Scene-transition fade + door SFX — **Done**
- TASK-356 (#202): Indoor ambience + indoor/outdoor time-pause — **Backlog**
...
- TASK-345 (#194): Early rival-awareness fairness gap — **Backlog** (status unclear)
...
- TASK-321 (mining), TASK-322 (upgrades), TASK-323 (livestock depth), TASK-324 (life-progression), TASK-325 (companion bond), TASK-326 (stamina/shipping milestone) — **Done**
- TASK-327 (seed shop) — **Done**
...
|---|---|---|---|---|
| TASK-356 — Indoor ambience + explicit indoor/outdoor time-pause decision (#202) | Cline (delegate) | Claude (Code Quality Review + merge) |  | ops/backlog-inbox.md + GitHub #202 |